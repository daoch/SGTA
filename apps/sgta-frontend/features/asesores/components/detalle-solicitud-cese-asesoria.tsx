...
import { Check, AlertCircle, RefreshCw, Loader2, Calendar, Users, Clock, User, X } from 'lucide-react';
...
import { IRequestTerminationConsultancyRequestData } from '../dtos/solicitudes-cese-asesoria';
                    ...
                    <CardContent className="py-3 px-4 text-xs h-full">
                        ...
                        {request.students.length > 0 && (
                            <div className="mb-1 p-2">
                                <span className="text-[11px] text-gray-500 font-medium mb-0.5">{request.status==="approved"?"Tesistas reasignados: ":request.status==="rejected"?"Tesistas asociados: ": ""}</span>
                                <Badge variant="secondary">{request.students.length}</Badge>
