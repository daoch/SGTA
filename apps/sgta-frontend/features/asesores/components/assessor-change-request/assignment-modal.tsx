...
export function AssessorChangeAssignmentModal({ open, onOpenChange, request }: Readonly<IAssessorChangeRequestAssignmentModalProps>) {
  ...
  /*
  //const debouncedFullNameEmail = useDebounce(searchCriteria.fullNameEmail, 400);
  //const { data, isError, error, refetch } = useRequestTerminationAdvisorPerThematicArea({idThematicArea: request.student.topic.thematicArea.id, fullNameEmailCode: "", page: page})
  */
