...
import { getReasignacionesPendientes } from "../services/coordinador.service"; // Ajusta la ruta a tu archivo de servicios
...
} from "../types/reasignacion.types"; // Ajusta la ruta
