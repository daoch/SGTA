...
import {
  ISelectRequestCessationOptions,
...
const Page = () => {
  ...
  const [selectOption, setSelectOption] =
    useState<ISelectRequestCessationOptions>(initialStateOption);
      ...
      <div className="container mx-auto py-8 px-4 max-w-7xl space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground max-w-3xl">
            Revise y gestione las solicitudes de cese de asesoría enviadas por
            los profesores. Al aprobar una solicitud, deberá reasignar los
            tesistas afectados a nuevos asesores.
          </p>
        </div>
