...
interface NuevoCriterioEntregableModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (criteriosSeleccionados: CriterioEntregable[]) => void;
...
export const NuevoCriterioEntregableModal: React.FC<NuevoCriterioEntregableModalProps> = ({
  ...
  const handleCheckboxChange = (criterio: CriterioEntregable) => {
