    ...
    return (
      <div className="p-6 text-center space-y-4">
        <p className="text-green-700">
          ¡Registro exitoso! Hemos enviado un enlace de verificación a{" "}
          <strong>{emailSentTo}</strong>. Revisa tu bandeja de entrada y haz
  ...
  return (
    <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="grid gap-2">
        <Label>Nombre</Label>
        <Input
          {...register("givenName", { required: "El nombre es obligatorio" })}
        />
        {errors.givenName && (
