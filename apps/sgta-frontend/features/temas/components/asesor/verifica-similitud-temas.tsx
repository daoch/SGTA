...
import { TemaSimilitud } from "../../types/temas/entidades";

interface VerificaSimilitudTemasProps {
...
export default function VerificaSimilitudTemas({
  propuestas,
  onCancel,
  onContinue,
  checkingSimilitud,
}: VerificaSimilitudTemasProps) {
  ...
  return (
    <div className="w-full max-w-xl mx-auto p-6 bg-white rounded-xl">
      ...
      <p className="text-sm text-muted-foreground mt-1 mb-4">
        ...
        proyectos de fin de carrera existentes. Revisa las coincidencias antes
        de continuar.
      </p>
