...
export async function updateBloquesListFirstTime(bloquesList:TimeSlot[]) {
  ...
  export async function updateBloquesNextPhase(bloquesList:TimeSlot[]){
    ...
    try {
      ...
      console.error("Error al actualizar la lista de bloques siguiente fase:", error);      
      
      return { success: false, message: "Error inesperado al actualizar bloques siguiente fase" };
    }
  }
