...
interface ModalAsignarTesisProps {
  ...
  export const ModalAsignarTesis: React.FC<ModalAsignarTesisProps> = ({ open, onClose, onAsignar,jurado, data  }) => {
    const [search, setSearch] = useState('')
    const [especialidad, setEspecialidad] = useState('')
    const [tesisSeleccionada, setTesisSeleccionada] = useState<any | null>(null)
    const [especialidadesSeleccionadas, setEspecialidadesSeleccionadas] = useState<string[]>(jurado.specialties || [])
    ...
    return (
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent 
        className="flex flex-col w-[811px] h-[496px] max-w-none !max-w-[100vw]"
        ...
        >
          ...
          <div className="flex gap-4 mb-4">
            ...
            options={[
                ...
                { label: "Tecnologias de la informacion", value: "Tecnologias de la informacion" },
