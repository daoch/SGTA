    ...
    const roomAvailList: Dispo[] = [
        {
          ...
          startTime: "08:00",
          endTime: "09:00",
          spaces: [{ code: "V201", busy: false },{code: "V202", busy :false},
                    {code: "V203", busy :false},{code: "V204", busy :false}],
        },
        {
          code: 2,
      ...
      function handleDragEnd(event:DragEndEvent){
       ...
       /*checks if the item being dragged is in the list of unassigned expositions.*/
        ...
        if(chosenExpo){
          ...
          const chosenExpo = Object.values(assignedExpos).find(a => a.code === expoId);
          if(chosenExpo){
            const newAssignment = {
              [spaceId] : chosenExpo
            };
      ...
      const removeExpo = (expo: Exposicion) => {
        //find the click expo
        const clickedExpo = Object.values(assignedExpos).find(a => a.code === expo.code);
      ...
      return(
        <main className="h-screen flex flex-col">
          <div className="py-4">
            <h1 className="text-blue-900 font-bold text-2xl" style={{color:"#042354"}}>
