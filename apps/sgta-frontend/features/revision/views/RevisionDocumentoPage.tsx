...
const revisionData = {
  ...
  observaciones: [
    ...
    },
    {
      ...
      parrafo: 3,
      texto:
        "Se detectó un posible plagio en este párrafo. Verificar la fuente original y citar correctamente.",
      tipo: "plagio",
      resuelto: false,
    },
    {
...
export default function RevisarDocumentoPage({
  params,
}: {
  params: { id: string };
}) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-3xl font-bold text-pucp-blue">
            Revisar Documento
          </h1>
        </div>
        <Dialog
        ...
        >
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Confirme los resultados de la revisión antes de finalizar.
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="gap-2"
                    onClick={handleFormatoValidoChange}
                  >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="gap-2"
                    onClick={handleCitadoCorrectoChange}
                  >
                  ...
                  <div>
                    ...
                    <div className="text-xs">
                      <span className="text-green-600">
                        {
                          revision.observaciones.filter((o) => o.resuelto)
                            .length
                        }{" "}
                        resueltas
                      </span>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <Tabs
                value={tab}
                onValueChange={(v) => setTab(v as "revisor" | "plagio")}
              >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline" className="bg-red-100 text-red-800">
                    {
                      revision.observaciones.filter((o) => o.tipo === "plagio")
                        .length
                    }
                  </Badge>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    {
                      revision.observaciones.filter((o) => o.tipo === "citado")
                        .length
                    }
                  </Badge>
                </div>
