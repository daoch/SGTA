  ...
  return (
    <div className="space-y-8 mt-4">
      <div>
        ...
        <p className="text-muted-foreground">Postulaciones de asesores interesados en tus propuestas de proyecto de fin de carrera</p>
      </div>
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction
                        ...
                        onClick={() => {
                          // Aquí actualizas el estado o llamas tu lógica de rechazo
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction
                        ...
                        onClick={() => {
                          // Aquí actualizas el estado o llamas tu lógica de aceptación
