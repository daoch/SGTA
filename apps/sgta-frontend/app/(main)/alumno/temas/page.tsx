...
const propuestas: Propuesta[] = [
  {
    ...
    tipo: "directa",
    descripcion: "Desarrollo de una plataforma web para la gestión integral de eventos académicos que utilice inteligencia artificial para optimizar la programación y asignación de recursos.",
    objetivos: "Crear una interfaz intuitiva para la gestión de eventos. Implementar algoritmos de IA para optimizar horarios. Desarrollar un sistema de notificaciones automáticas.",
  ...
  },
  {
    ...
    tipo: "general",
    descripcion: "Diseño e implementación de un sistema de monitoreo ambiental en tiempo real usando sensores conectados mediante IoT.",
    objetivos: "Recolectar datos ambientales. Procesar datos en la nube. Visualizar información en dashboard.",
    estado: "propuesta",
  },
  {
    id: "3",
    ...
    tipo: "directa",
    descripcion: "Aplicación de técnicas de NLP para analizar sentimientos en publicaciones de redes sociales con fines de estudio de mercado.",
    objetivos: "Clasificar publicaciones por sentimiento. Evaluar tendencias por marca. Automatizar alertas de menciones negativas.",
  ...
  },
  {
    ...
    tipo: "general",
    descripcion: "Desarrollar un sistema que prediga la demanda de productos usando modelos de machine learning supervisado.",
    objetivos: "Obtener histórico de ventas. Entrenar modelos predictivos. Validar predicciones con nuevas ventas.",
    estado: "propuesta",
  }
];
    ...
    <div className="space-y-8 mt-4">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Gestión de tus temas de proyecto de fin de carrera, postulaciones y propuestas</p>
        </div>
        ...
        <TabsContent value="postulaciones">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Temas de proyectos de fin de carrera a los que has postulado</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="propuestas">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Temas de proyectos de fin de carrera que has propuesto</CardDescription>
            </CardHeader>
            <CardContent>
