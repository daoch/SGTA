...
const Page: React.FC = () => {
  ...
  const [fechas, setFechas] = useState([{ fecha: '', horaInicio: '', horaFin: '', sala: '' }]);
  ...
  const handleFechaChange = (index: number, field: 'fecha' | 'horaInicio' | 'horaFin' | 'sala', value: string) => {
  ...
  return (
    <div className="flex flex-col p-6 w-full">
      ...
      {/* Modal Step 1 */}
      <Dialog open={openStep1} onOpenChange={(val) => { setOpenStep1(val); if (!val) handleCloseModal(); }}>
        <DialogContent>
          <DialogHeader>
          ...
          <div className="flex flex-col mt-4">
            ...
            <Select value={curso} onValueChange={setCurso}>
              ...
              <SelectContent>
                <SelectItem value="Proyecto de Fin de Carrera 1">Proyecto de Fin de Carrera 1</SelectItem>
                <SelectItem value="Proyecto de Fin de Carrera 2">Proyecto de Fin de Carrera 2</SelectItem>
              </SelectContent>
            </Select>
          </div>

          <div className="mt-6 flex justify-end">
            <Button onClick={() => { setOpenStep1(false); setOpenStep2(true); }} disabled={!curso} variant="default" className="text-white bg-blue-900 hover:bg-blue-800 py-2 px-6">
              Continuar
            </Button>
          </div>
        </DialogContent>
      ...
      {/* Modal Step 2 */}
      <Dialog open={openStep2} onOpenChange={(val) => { 
        setOpenStep2(val); 
        ...
        <DialogContent>
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Antes de ingresar al planificador de exposiciones, ingrese el tipo de exposición.
          </p>

          {/* Curso seleccionado bloqueado */}
          <div className="flex flex-col mt-4">
            <Label htmlFor="curso" className="text-sm mb-1">Curso</Label>
            <Input
              type="text"
              value={curso}
              disabled
          ...
          {/* Tipo de exposición */}
          <div className="flex flex-col mt-4">
            <Label htmlFor="tipoExposicion" className="text-sm mb-1">Tipo Exposición</Label>
          ...
          <div className="mt-6 flex justify-between">
            <Button
              onClick={() => { setOpenStep2(false); setOpenStep1(true); }}
              variant="outline"
              className="py-2 px-6"
            >
              Cancelar
            ...
            <Button
              onClick={() => { setOpenStep2(false); setOpenStep3(true); }}
      ...
      {/* Modal Step 3 */}
      <Dialog open={openStep3} onOpenChange={(val) => { setOpenStep3(val); if (!val) handleCloseModal(); }}>
        <DialogContent>
          <DialogHeader>
          ...
          <div className="flex flex-col mt-4">
            ...
            <Input type="text" value={curso} disabled className="border rounded px-3 py-2 dark:bg-gray-800 dark:text-white" />
          </div>
          ...
          <div className="flex flex-col mt-4">
            ...
            <Input type="text" value={tipoExposicion} disabled className="border rounded px-3 py-2 dark:bg-gray-800 dark:text-white" />
          </div>

          {fechas.map((f, index) => (
          <div key={index} className="flex gap-4 mt-4 items-end">
            <div className="flex flex-col w-1/4">
              <Label htmlFor="fecha" className="text-sm mb-1">Fecha Exposición</Label>
              <Input
                type="date"
                value={f.fecha}
            ...
            <div className="flex flex-col w-1/4">
              <Label htmlFor="horaInicio" className="text-sm mb-1">Hora Inicio</Label>
              <Input
                type="time"
                value={f.horaInicio}
                onChange={(e) => handleFechaChange(index, 'horaInicio', e.target.value)}
                className="px-3 py-2"
              />
            </div>

            <div className="flex flex-col w-1/4">
              <Label htmlFor="horaFin" className="text-sm mb-1">Hora Fin</Label>
              <Input
                type="time"
                value={f.horaFin}
                onChange={(e) => handleFechaChange(index, 'horaFin', e.target.value)}
                className="px-3 py-2"
              />
            </div>

            <div className="flex flex-col w-1/4">
              <Label htmlFor="sala" className="text-sm mb-1">Sala Habilitada</Label>
              <Select value={f.sala} onValueChange={(value) => handleFechaChange(index, 'sala', value)}>
          ...
          <div className="mt-4">
            <Button onClick={agregarFila} variant="default" className="text-white bg-blue-900 hover:bg-blue-800 py-2 px-6">
          ...
          <div className="mt-6 flex justify-between">
            ...
            <Button onClick={handleAceptar} variant="default" className="text-white bg-blue-900 hover:bg-blue-800 py-2 px-6">
              Continuar
            </Button>
          </div>
        </DialogContent>
