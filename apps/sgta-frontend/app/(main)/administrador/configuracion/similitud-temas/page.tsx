...
import { OAIEndpointConfigCard } from "@/features/administrador/components/oai-endpoint-config-card";
import { OAINavigationCard } from "@/features/administrador/components/oai-navigation-card";
  ...
  return (
    <div className="py-6">
      ...
      <div className="space-y-8">
        {/* Embeddings Section */}
        <div>
          <h2 className="text-xl font-semibold mb-4">Gestión de Embeddings</h2>
          <p className="text-gray-600 text-sm mb-6">
            Configure y administre los embeddings para el análisis de similitud entre temas.
          </p>
        ...
        {/* OAI Configuration Section */}
        <div>
          <h2 className="text-xl font-semibold mb-4">Configuración de Integraciones</h2>
          <p className="text-gray-600 text-sm mb-6">
            Configure las integraciones externas para la gestión de temas y metadatos.
          </p>
          <div className="space-y-6">
            <OAIEndpointConfigCard />
            <OAINavigationCard />
          </div>
        </div>
      </div>
