                        ...
                        {propuestasFiltradas.length === 0 ? (
                            ...
                            propuestasFiltradas.map((tema) => (
                                <TableRow key={tema.id}>
                                    <TableCell className="font-medium max-w-xs truncate">{tema.titulo}</TableCell>
                                    <TableCell>{tema.area}</TableCell>
                                    <TableCell>{tema.asesor}</TableCell>
                                    <TableCell>{!tema.estudiantes ? "Sin asignar" : tema.estudiantes.map(e => e.nombre).join(", ")}</TableCell>
                                    <TableCell>
