...
//         mockData.add(new Object[]{1, Instant.now().plusSeconds(3600), Instant.now().plusSeconds(7200), 102, "Sala 2"});
...
//         List<JornadaExposicionXSalaExposicionListadoDTO> result = jornadaService.listarJornadasExposicionSalas(etapaFormativaId);
