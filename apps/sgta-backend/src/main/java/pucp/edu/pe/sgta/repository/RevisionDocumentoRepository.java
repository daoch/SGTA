...
public interface RevisionDocumentoRepository extends JpaRepository<RevisionDocumento, Integer> {
    ...
    /**
     * Consulta para obtener todas las revisiones con la información completa para el endpoint
     * Devuelve los datos necesarios para construir el DTO RevisionDto
     * Esta consulta usa CAST para asegurar compatibilidad con los tipos de datos existentes
     */
    @Query(value = """
        SELECT 
