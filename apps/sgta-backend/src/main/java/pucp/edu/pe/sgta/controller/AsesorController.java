...
import pucp.edu.pe.sgta.service.inter.AsesorService;         // Servicio para lógica de asesor
import pucp.edu.pe.sgta.service.inter.SolicitudAsesorService; // Servicio para lógica de solicitudes de cese del asesor
...
public class AsesorController {
    ...
    @Autowired
    private AsesorService asesorService; // Para obtener temas activos del asesor

    @Autowired
    private SolicitudAsesorService solicitudAsesorService; // Para crear y listar solicitudes de cese del asesor
