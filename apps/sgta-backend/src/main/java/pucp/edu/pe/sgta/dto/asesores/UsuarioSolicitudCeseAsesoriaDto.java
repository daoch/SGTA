...
@Setter
@Getter
public class UsuarioSolicitudCeseAsesoriaDto {
    private int id;
    ...
    public static UsuarioSolicitudCeseAsesoriaDto fromQueryResult(Object[] result) {
        UsuarioSolicitudCeseAsesoriaDto dto = new UsuarioSolicitudCeseAsesoriaDto();
        dto.id = (int)result[0];
