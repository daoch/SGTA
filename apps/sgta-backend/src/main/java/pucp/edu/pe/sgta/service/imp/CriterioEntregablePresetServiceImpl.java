...
public class CriterioEntregablePresetServiceImpl implements CriterioEntregablePresetService {
    ...
    public void delete(Integer criterioEntregablePresetId) {
        CriterioEntregablePreset criterioEntregablePresetToDelete = criterioEntregablePresetRepository.findById(criterioEntregablePresetId)
                .orElseThrow(() -> new RuntimeException("CriterioEntregablePreset no encontrado con ID: " + criterioEntregablePresetId));
