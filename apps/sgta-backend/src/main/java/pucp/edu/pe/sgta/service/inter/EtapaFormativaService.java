...
public interface EtapaFormativaService {
	...
	/*
	 * // Crea el vínculo entre una etapa Formativa y un Ciclo nuevo void
	 * vincularACiclo(Integer etapaFormativaId, Integer cicloId);
	 *
	 * // Marca el vínculo existente como FINALIZADO void finalizar(Integer
	 * etapaFormativaXCicloId);
	 *
	 * // Reactiva un vínculo finalizado (vuelve a EN_CURSO) void reactivar(Integer
	 * etapaFormativaXCicloId);
	 *
