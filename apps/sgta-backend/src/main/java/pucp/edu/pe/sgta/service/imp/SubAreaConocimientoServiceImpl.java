...
public class SubAreaConocimientoServiceImpl implements SubAreaConocimientoService {
	...
	public SubAreaConocimientoServiceImpl(SubAreaConocimientoRepository subAreaConocimientoRepository,
			AreaConocimientoRepository areaConocimientoRepository, CarreraRepository carreraRepository,
	...
	public List<SubAreaConocimientoDto> listarPorCarreraDeUsuario(Integer usuarioId) {
		...
		Query query = entityManager.createNativeQuery(sql).setParameter("p_usuario_id", usuarioId);
