...
DROP FUNCTION IF EXISTS enlazar_tesistas_tema_propuesta_directa(INTEGER[], INTEGER, INTEGER, TEXT) CASCADE;
...
DROP FUNCTION IF EXISTS postular_asesor_a_tema(INTEGER, INTEGER, INTEGER, TEXT) CASCADE;
