...
DROP FUNCTION IF EXISTS aprobar_postulacion_propuesta_general_tesista (
    p_tema_id INTEGER,
    p_asesor_id INTEGER,
...
DROP FUNCTION IF EXISTS atender_solicitud_resumen (
    p_solicitud_id INTEGER,
    p_summary TEXT,
    p_response TEXT
) CASCADE;

DROP FUNCTION IF EXISTS atender_solicitud_titulo (
    p_solicitud_id INTEGER,
    p_title VARCHAR,
    p_response TEXT
) CASCADE;
...
DROP FUNCTION IF EXISTS get_solicitudes_by_tema (
...
DROP FUNCTION IF EXISTS listar_postulaciones_del_tesista_con_usuarios (
    p_tesista_id INTEGER,
    p_tipo_post INTEGER
) CASCADE;
...
DROP FUNCTION IF EXISTS listar_temas_propuestos_al_asesor (
    p_asesor_id INTEGER,
    p_titulo TEXT,
    p_limit INTEGER,
    p_offset INTEGER
...
DROP FUNCTION IF EXISTS listar_temas_propuestos_por_subarea_conocimiento (
...
DROP FUNCTION IF EXISTS rechazar_postulacion_propuesta_general_tesista (
    p_tema_id INTEGER,
    p_asesor_id INTEGER,
    p_tesista_id INTEGER
) CASCADE;
...
DROP PROCEDURE IF EXISTS terminar_planificacion (
    idexposicion INTEGER,
    idetapaformativa INTEGER
) CASCADE;
...
DROP PROCEDURE IF EXISTS procesar_solicitud_cambio (
    INTEGER,
    TEXT,
    INTEGER,
    BOOLEAN
...
DROP FUNCTION IF EXISTS listar_temas_por_usuario_rol_estado (
    INTEGER,
    TEXT,
    TEXT,
    INTEGER,
...
DROP FUNCTION IF EXISTS listar_temas_por_estado_y_carrera (
    TEXT,
    INTEGER,
    INTEGER,
    INTEGER
...
DROP FUNCTION IF EXISTS obtener_datos_exposicion (integer) CASCADE;
