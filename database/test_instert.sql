...
WITH nuevo_parametro AS (
    INSERT INTO parametro_configuracion (
        nombre, descripcion, modulo_id, activo, fecha_creacion, fecha_modificacion, tipo
          ...
          2, TRUE, NOW(), NOW(), 'integer') RETURNING parametro_configuracion_id)
INSERT 
    INTO carrera_parametro_configuracion (carrera_id, parametro_configuracion_id, valor, activo, fecha_creacion, fecha_modificacion, etapa_formativa_id)
SELECT 1, parametro_configuracion_id, 3, TRUE, NOW(), NOW(), 1
FROM nuevo_parametro;
...
WITH nuevo_parametro AS (
    INSERT INTO parametro_configuracion (
        ...
        2, TRUE, NOW(), NOW(), 'booleano') RETURNING parametro_configuracion_id)
INSERT 
    INTO carrera_parametro_configuracion (carrera_id, parametro_configuracion_id, valor, activo, fecha_creacion, fecha_modificacion, etapa_formativa_id)
SELECT 1, parametro_configuracion_id, true, TRUE, NOW(), NOW(), 1
FROM nuevo_parametro;
...
INSERT 
    INTO carrera_parametro_configuracion (carrera_id, parametro_configuracion_id, valor, activo, fecha_creacion, fecha_modificacion, etapa_formativa_id)
SELECT 1, parametro_configuracion_id, 5, TRUE, NOW(), NOW(), 1
FROM nuevo_parametro;
...
WITH nuevo_parametro AS (
    INSERT INTO parametro_configuracion (
        ...
        3, TRUE, NOW(), NOW(), 'integer') RETURNING parametro_configuracion_id)
INSERT 
    INTO carrera_parametro_configuracion (carrera_id, parametro_configuracion_id, valor, activo, fecha_creacion, fecha_modificacion, etapa_formativa_id)
SELECT 1, parametro_configuracion_id, 4, TRUE, NOW(), NOW(), 1
FROM nuevo_parametro;
